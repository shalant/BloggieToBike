...
namespace BloggieToBike.Web.Pages.BikeRoute
{
    public class DetailsModel : PageModel
    {
        ...
        {
            var bikeRouteComments = await bikeRouteCommentRepository.GetAllAsync(BikeRoutePost.Id);

            var bikeRouteComments = new List<Models.Domain.BikeRouteComment>();
            foreach (var blogPostComment in bikeRouteComments)
            {
                bikeRouteCommentsViewModel.Add(new Models.Domain.BikeRouteComment
                {
            ...
            Comments = bikeRouteCommentsViewModel;
        }
